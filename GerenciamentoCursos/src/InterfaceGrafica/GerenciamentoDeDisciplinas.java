...
public class GerenciamentoDeDisciplinas extends JFrame {

	private JPanel contentPane;
	public static GerenciamentoDeDisciplinas instance;
    public static GerenciamentoDeDisciplinas getInstace() {
    	if (GerenciamentoDeDisciplinas.instance == null) {
			return GerenciamentoDeDisciplinas.instance = new GerenciamentoDeDisciplinas();
		}
		return GerenciamentoDeDisciplinas.instance;
    }
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GerenciamentoDeDisciplinas frame = new GerenciamentoDeDisciplinas();
	...
	public GerenciamentoDeDisciplinas() {
		...
		JLabel lblGerenciamentoDeCursos = new JLabel("Gerenciamento De Disciplinas");
		lblGerenciamentoDeCursos.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblGerenciamentoDeCursos.setBounds(18, 11, 414, 74);
