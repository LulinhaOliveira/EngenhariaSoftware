...
public class GerenciamentoOfertas extends JFrame {

	private JPanel contentPane;
	public static GerenciamentoOfertas instance;
	public static GerenciamentoOfertas getInstace() {
		if (GerenciamentoOfertas.instance == null) {
			return GerenciamentoOfertas.instance = new GerenciamentoOfertas();
		}
		return GerenciamentoOfertas.instance;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GerenciamentoOfertas frame = new GerenciamentoOfertas();
	...
	public GerenciamentoOfertas() {
		...
		JLabel lblGerenciamentoDeCursos = new JLabel("Gerenciamento De Ofertas");
