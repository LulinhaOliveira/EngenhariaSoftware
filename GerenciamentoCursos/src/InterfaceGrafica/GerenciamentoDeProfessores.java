...
public class GerenciamentoDeProfessores extends JFrame {

	private JPanel contentPane;
	public static GerenciamentoDeProfessores instance;
	public static GerenciamentoDeProfessores getInstace() {
		if (GerenciamentoDeProfessores.instance == null) {
			return GerenciamentoDeProfessores.instance = new GerenciamentoDeProfessores();
		}
		return GerenciamentoDeProfessores.instance;
	}
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GerenciamentoDeProfessores frame = new GerenciamentoDeProfessores();
	 ...
	 * Create the frame.
	 */
	public GerenciamentoDeProfessores() {
		...
		JLabel lblGerenciamentoDeCursos = new JLabel("Gerenciamento De Professores");
		lblGerenciamentoDeCursos.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblGerenciamentoDeCursos.setBounds(28, 11, 414, 74);
