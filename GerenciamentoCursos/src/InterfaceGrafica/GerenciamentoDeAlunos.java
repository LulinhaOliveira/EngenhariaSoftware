...
public class GerenciamentoDeAlunos extends JFrame {
	...
	public static GerenciamentoDeAlunos instance;
	public static GerenciamentoDeAlunos getInstace() {
		if (GerenciamentoDeAlunos.instance == null) {
			return GerenciamentoDeAlunos.instance = new GerenciamentoDeAlunos();
		}
		return GerenciamentoDeAlunos.instance;
	}
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GerenciamentoDeAlunos frame = new GerenciamentoDeAlunos();
	...
	public GerenciamentoDeAlunos() {
		...
		JLabel lblGerenciamentoDeCursos = new JLabel("Gerenciamento De Alunos");
		lblGerenciamentoDeCursos.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblGerenciamentoDeCursos.setBounds(41, 11, 414, 74);
